...
public class TileBoard {
    ...
    public void checkForWinner(){
        checkRowsForWinner();
        checkColsForWinner();
        checkTopLeftToBottomRightFowWinner();
        checkTopRightToBottomRightFowWinner();
        checkForStalemate();
    }
    ...
    private void checkTopRightToBottomRightFowWinner() {
        if (!isEndOfGame) {
            if (tiles[0][2].getValue().equals(tiles[1][1].getValue()) &&
                ...
                endGame(winner, new WinningTiles(tiles[0][2], tiles[1][1],tiles[2][2]));
                return;
            }
    ...
    private void checkTopLeftToBottomRightFowWinner() {
        if (!isEndOfGame) {
